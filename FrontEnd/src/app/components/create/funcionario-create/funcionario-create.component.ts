...
export class FuncionarioCreateComponent implements OnInit {
  ...
  constructor(public dialog: MatDialog, private ffService: FfService, private ftService: FtService,private funcionarioService: FuncionarioService, private route: Router, private dateAdapter: DateAdapter<Date>, private ufService: UfService, private cidadeService: CidadeService) {
  ...
  createfuncionario(){
    this.isLoading = true;
    setTimeout(() => {
      this.funcionarioService.createFuncionario(this.funcionarioForm).subscribe((data) => {
